...
export function Navbar() {
  ...
  // No navbar at all for a logged-out visitor -- the landing/login/signup
  // pages are self-contained (their own cross-links), so there's nothing
  // for this bar to usefully show them. Also hidden during the brief
  // session-loading window rather than flashing the bar and then removing
  // it once useAuth resolves.
